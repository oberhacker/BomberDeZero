...
public class EnemigoMoneda extends EnemigoBase {
	...
	public EnemigoMoneda(BomberGame context) {
		super(context);
	}
	...
	public void attachSpriteGroup() {
		...
		if (spritePrincipal!=null){
			...
			spritePrincipal = new AnimatedSprite(0, 0, context.almacenEnemigos.monedaTR, context.getVertexBufferObjectManager());
			...
			context.almacenEnemigos.groupMoneda.attachChild(spritePrincipal);
